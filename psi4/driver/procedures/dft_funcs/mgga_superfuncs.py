...
def build_m11_l_superfunctional(name, npoints, deriv):
    ...
    # Add member functionals
    sup.add_x_functional(core.Functional.build_base('XC_MGGA_X_M11_L'))
    sup.add_c_functional(core.Functional.build_base('XC_MGGA_C_M11_L'))

    # Call this last
    sup.allocate()
    return (sup, False)

def build_mgga_ms0_superfunctional(name, npoints, deriv):
    ...
    # Add member functionals
    sup.add_x_functional(core.Functional.build_base('XC_MGGA_X_MS0'))
    sup.add_c_functional(core.Functional.build_base('XC_GGA_C_REGTPSS'))
...
def build_mgga_ms1_superfunctional(name, npoints, deriv):
    ...
    # Add member functionals
    sup.add_x_functional(core.Functional.build_base('XC_MGGA_X_MS1'))
    sup.add_c_functional(core.Functional.build_base('XC_GGA_C_REGTPSS'))
...
def build_mgga_ms2_superfunctional(name, npoints, deriv):
    ...
    # Add member functionals
    sup.add_x_functional(core.Functional.build_base('XC_MGGA_X_MS2'))
    sup.add_c_functional(core.Functional.build_base('XC_GGA_C_REGTPSS'))
